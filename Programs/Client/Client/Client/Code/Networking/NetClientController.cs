...
namespace CarCRUD.Networking
{
    ...
    public class NetClientController
    {
        ...
        //Events
        public event ClientAcceptStop OnClientAcceptStoppedEvent;
        ...
        public async void AcceptClientsAsync(ClientConnectedHandler clientConnectedCallback = null)
        {
            ...
            if (OnClientAcceptStoppedEvent != null)
                OnClientAcceptStoppedEvent.Invoke(this);
        }
        ...
        public bool AttachClient(NetClient _client)
        {
            ...
            if (autoRemove)
                _client.OnClientDisconnectedEvent += RemoveClientOnDisconnect;
